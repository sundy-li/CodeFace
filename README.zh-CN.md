...
- 在 CodeFace 内搜索市场、检查更新、备份回滚主题并导出可分享主题包
...
从 CodexThemes 市场安装时，点击 **从 CodexThemes 安装**，粘贴 `portal-panic` 这类主题 ID 或 `https://codexthemes.ai/themes/<id>` 详情页网址，再点击 **安装**。CodeFace 会通过市场的匿名 API 下载官方主题包，完成校验并转换为本地 CodeFace 格式，然后选中它供你预览。标记为皮肤或不可安装压缩包的条目不支持此流程。
